...
export function DestinationAndDateStep({ closeGuestsInput, eventStartAndEndDates, isGuestsInputOpen, openGuestsInput, setDestination, setEventStartAndEndDates }:IDestinationAndDateStepProps) {
